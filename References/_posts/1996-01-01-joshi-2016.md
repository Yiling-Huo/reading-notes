...
@book{joshi2016python,
    ...
    author = {Joshi, Prateek},
    file = {:P\:/Literature/NLP/Machine Learning with Python Cookbook Practical Solutions from Preprocessing to Deep Learning by Chris Albon (z-lib.org).pdf:pdf},
    isbn = {978-1-78646-447-7},
    pages = {304},
    title = {Python Machine Learning CookBook},
    url = {http://proquest.safaribooksonline.com.ezproxy.lib.vt.edu/9781786464477},
    year = {2016},
}
```